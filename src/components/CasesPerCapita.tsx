    ...
    <div>
      ...
      <div className="legend">
        ...
        <Modal show={show} onHide={handleClose} centered>
          ...
          <Modal.Body>
            This map displays covid-19 cases per capita per country. For example if a country has had 0.01% covid-19
            cases per capita, that means 1 in every 10 000 people have been infected.
          </Modal.Body>
          <Modal.Footer>
