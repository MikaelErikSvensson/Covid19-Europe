...
export const addCountryColors = (array: Country[]): ColoredCountry[] => {
  ...
  // const maxPerCapita = findMax(array, (x) => x.casesPerCapita);
...
export const addConfirmedColors = (array: Country[]) => {
  const maxConfirmed = findMax(array, (x: Country) => {
    if (Number.isNaN(x.confirmed)) {
      return 0;
    } else {
      return x.confirmed;
...
export const addCasesPerCapitaColors = (array: Country[]) => {
  const maxPerCapita = findMax(array, (x: Country) => {
    if (Number.isNaN(x.casesPerCapita)) {
      return 0;
    } else {
      return x.casesPerCapita;
...
export const addDeathsColors = (array: Country[]) => {
  const maxDeaths = findMax(array, (x: Country) => {
    if (Number.isNaN(x.deaths)) {
      return 0;
    } else {
      return x.deaths;
...
export const addDeathRateColors = (array: Country[]) => {
  const maxDeathRate = findMax(array, (x: Country) => {
    if (Number.isNaN(x.deathRate)) {
      return 0;
    } else {
      return x.deathRate;
